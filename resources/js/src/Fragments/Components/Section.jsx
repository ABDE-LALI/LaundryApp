...
export function Section() {
    const sections = {
        Statistiques: {
            element: <>
                <svg fill="none" height="24" strokeWidth="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
                    {/* New Icon: Bar Chart for Statistics */}
        ...
        TakeOrders: {
            element: <>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
                    {/* New Icon: Shopping Cart for Take Orders */}
        ...
        ShowOrder: {
            element: <>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
                    {/* New Icon: Magnifying Glass for Search */}
        ...
        Parametres: {
            element: <>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
                    {/* New Icon: Gear for Settings (unchanged conceptually) */}
    ...
    return (
        <>
            {Object.entries(sections).map(([key, value]) => (
                <Link href={route(value.route)} className="sec" key={key}>
                    {value.element}
                </Link>
